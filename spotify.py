...
def getUserInfo(access_token):
    ...
    try:
        user_info_response = requests.get(
            'https://api.spotify.com/v1/me', headers=user_header)
...
def getRecSong(access_token):
    ...
    song_response = requests.get(
        "https://api.spotify.com/v1/recommendations", params=user_params, headers=user_header)
    song = song_response.json()
    requests.put("https://api.spotify.com/v1/me/player/play",
                 json={"uris": [song['tracks'][0]['uri']]}, headers=user_header)
